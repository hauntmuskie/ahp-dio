...
public class PengaturanKriteria extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cbKriteria1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih Kriteria -", "Performa",
                "Harga", "Penyimpanan", "Daya Tahan Baterai", "RAM" }));

        cbKriteria2.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
        cbKriteria2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih Kriteria -", "Performa",
                "Harga", "Penyimpanan", "Daya Tahan Baterai", "RAM" }));

        cbKriteria3.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
        cbKriteria3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih Kriteria -", "Performa",
                "Harga", "Penyimpanan", "Daya Tahan Baterai", "RAM" }));

        cbKriteria4.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
        cbKriteria4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih Kriteria -", "Performa",
                "Harga", "Penyimpanan", "Daya Tahan Baterai", "RAM" }));
        ...
        cbKriteria5.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih Kriteria -", "Performa",
                "Harga", "Penyimpanan", "Daya Tahan Baterai", "RAM" }));
