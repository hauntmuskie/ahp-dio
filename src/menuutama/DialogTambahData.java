...
public class DialogTambahData extends javax.swing.JDialog {
    ...
    public void setDataTabel(String id_supplier, String nama_supplier, String email, String no_telp, String alamat, String kualitas, String harga, String layanan, String ketepatan_pengiriman, String ketepatan_jumlah){
        ...
        tNamaLaptop.setText(nama_supplier);
        tMerk.setText(email);
        tNoBobot.setText(no_telp);
        tTahun.setText(alamat);
        cbPerforma.setSelectedItem(kualitas);
        cbHarga.setSelectedItem(harga);
        cbPenyimpanan.setSelectedItem(layanan);
        cbKetepatanKetahananBaterai.setSelectedItem(ketepatan_pengiriman);
        cbKetepatanRam.setSelectedItem(ketepatan_jumlah);
    }
    ...
    private void insertDataPaket(){        
        String sql = "INSERT INTO data_supplier VALUES (?,?,?,?,?,?,?,?,?,?)";
            try{
                ...
                stat.setString(4, tNoBobot.getText());
                stat.setString(5, tTahun.getText());
                stat.setString(6, cbPerforma.getSelectedItem().toString());
                stat.setString(7, cbHarga.getSelectedItem().toString());
                stat.setString(8, cbPenyimpanan.getSelectedItem().toString());
                stat.setString(9, cbKetepatanKetahananBaterai.getSelectedItem().toString());
                stat.setString(10, cbKetepatanRam.getSelectedItem().toString());
                stat.executeUpdate();
    ...
    private void editDataPaket(){
        try{
            ...
            stat.setString(3, tNoBobot.getText());
            stat.setString(4, tTahun.getText());
            stat.setString(5, cbPerforma.getSelectedItem().toString());
            stat.setString(6, cbHarga.getSelectedItem().toString());
            stat.setString(7, cbPenyimpanan.getSelectedItem().toString());
            stat.setString(8, cbKetepatanKetahananBaterai.getSelectedItem().toString());
            stat.setString(9, cbKetepatanRam.getSelectedItem().toString());
    ...
    private void initComponents() {
        ...
        jPanel12.getAccessibleContext().setAccessibleName("Penilaian Bobot Laptop");
    ...
    private void tombolTambahMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tombolTambahMouseClicked
        ...
        if(!tNamaLaptop.getText().equals("") && !tMerk.getText().equals("") && !tNoBobot.getText().equals("") && !tTahun.getText().equals("")  
                && cbPerforma.getSelectedIndex() != 0 && cbHarga.getSelectedIndex() != 0 && cbPenyimpanan.getSelectedIndex() != 0 
